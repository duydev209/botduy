...
const loadCommand = function ({ moduleList, threadID, messageID }) {
  ...
  if (moduleList.length - errorList.length == 1) return api.sendMessage("✅", threadID)
  if (moduleList.length - errorList.length == 0) return api.sendMessage("❎", threadID)
