...
🪙 𝗧𝗵𝗮̉ 𝗰𝗮̉𝗺 𝘅𝘂́𝗰 "👍" 𝘃𝗮̀𝗼 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 đ𝗲̂̉ 𝘅𝗲𝗺 𝘁𝗵𝗼̂𝗻𝗴 𝘁𝗶𝗻 𝘃𝗲̂̀ 𝗯𝗼𝘁 𝗺𝗮̀ 𝗯𝗮̣𝗻 đ𝗮𝗻𝗴 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗖𝗵𝘂́𝗰 𝗯𝗮̣𝗻 𝗰𝗼́ 𝟭 𝗻𝗴𝗮̀𝘆 𝗺𝗼̛́𝗶 𝘃𝘂𝗶 𝘃𝗲̉`
    const res1 = await axios.get(`http://api-vua-trang.tranng123123.repl.co/images/girl`);
const res2 = await axios.get(`http://api-vua-trang.tranng123123.repl.co/images/girl`);
const res3 = await axios.get(`http://api-vua-trang.tranng123123.repl.co/images/girl`);
const res4 = await axios.get(`http://api-vua-trang.tranng123123.repl.co/images/girl`);
const res5 = await
axios.get(`http://api-vua-trang.tranng123123.repl.co/images/girl`);
const res6 = await
axios.get(`http://api-vua-trang.tranng123123.repl.co/images/girl`);
...
var downloadfile6 = (await axios.get(data6, {responseType: 'stream'})).data;
    ...
    array.push(downloadfile6);        api.sendMessage({body: msg1 + msg, attachment: array},event.threadID, (err, info) => { 
