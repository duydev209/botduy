...
module.exports.run = async ({
  ...
  const moment = require("moment-timezone");
    var timeNow = moment.tz("Asia/Ho_Chi_Minh").format("DD/MM/YYYY || HH:mm:ss");
     if (args.length == 0) return api.sendMessage(`[ BOX CONFIG ]\n────────────────\n[🧸] Box id > Lấy ID Nhóm\n[🗿] Box name > Lấy Tên Nhóm\n[🐥] Box setnamebox ( tên ) > Đổi Tên Nhóm\n[🛖] Box info > Xem Thông Tin Nhóm\n[💌] Box me setqtv > Box Sẽ Thêm Bạn Làm QTV Nhóm\n[🔰] Box setqtv ( Tag ) > Thêm Người Dùng Làm QTV Nhóm\n[👽] Box emoji ( icon ) > Đổi Biểu Tượng Nhóm\n[🌹] Box image ( Phản Hồi Ảnh ) > Đổi Ảnh Nhóm\n[👥] Box new ( Tag ) > Tạo Nhóm Với Thành Viên Được Tag\n[🗣] Box taobinhchon > Tạo Bình Chọn Trong Nhóm\n────────────────\n[✍️] Box setname ( Tag/Reply ) ( Biệt Danh ) > Đặt Biệt Danh Thành Viên Nhóm\n[🐦] Box setnameall ( Biệt Danh ) > Đặt Biệt Danh Cho Tất Cả Thành Viên Nhóm\n[🎊] Box rdcoler > Thiết Lập Chủ Đề Nhóm Ngẫu Nhiên\n────────────────\n[ ${timeNow} ]`, event.threadID, event.messageID);
