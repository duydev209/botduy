...
module.exports.config = {
    ...
    usePrefix: false,
    usages: "[register/shop/buy/info/sell/daily/top]",
    usages: "[coinmaster]",
    cooldowns: 0
};
...
module.exports.run = async function ({ api, event, args, Users, Currencies }) {
    ...
    switch (args[0]) {
        ...
        case '-s': {
            if (!existsSync(pathData)) {
                return api.sendMessage({body: "[🐖] Bạn chưa đăng kí game!", attachment: await this.image('https://i.imgur.com/kWy6PDS.jpeg')}, threadID, messageID);
            }
