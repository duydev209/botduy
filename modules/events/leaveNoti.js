module.exports.config = {
	...
	version: "1.0.0",
	credits: "",//tao không phải người code, mod all by QDuy //thay credit t chặt cu=))
...
module.exports.run = async function ({ api, event, Users, Threads }) {
    ...
    const type = (event.author == event.logMessageData.leftParticipantFbId) ? "𝐓ự 𝐁ấ𝐦 𝐍ú𝐭 𝐁𝐢ế𝐧" : "𝐁ị 𝐐𝐮ả𝐧 𝐓𝐫ị 𝐕𝐢ê𝐧 {author} 𝐊𝐢𝐜𝐤\n→ [🌐] Link 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐤𝐢𝐜𝐤:\nfb.com/{uidAuthor}";
	const path = join(__dirname, "cache", "leaveGif");
