    ...
    if (logMessageType == "log:thread-name") {
      if (isValid) {
        ...
        if (data.antist_info.name !== null) {
          return api.sendMessage("[ 𝐑𝐞𝐧𝐙𝐢𝐢 ] ➩ Hiện tại đang kích hoạt chế độ chống thay tên nhóm", threadID, () => {
      ...
      if (data.antist.boximage === true) {
        if (data.antist_info.imageSrc !== null && isValid == false) {
          ...
          return api.sendMessage("[ 𝐑𝐞𝐧𝐙𝐢𝐢 ] ➩ Hiện tại đang kích hoạt chế độ chống thay ảnh nhóm", threadID, async () => {
      ...
      if (!isValid && data.antist.theme == true) {
        if (data.antist_info.themeID) {
          return api.sendMessage("[ 𝐑𝐞𝐧𝐙𝐢𝐢 ] ➩ Hiện tại đang kích hoạt chế độ chống thay màu nhóm", threadID, () => {
