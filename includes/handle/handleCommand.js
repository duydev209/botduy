  ...
  return async function({ event }) {
    ...
    if (
      ...
      if (
        ...
        return api.sendMessage(
          '[ 𝐑𝐞𝐧𝐙𝐢𝐢 ] ➩ Admin bot mới sử dụng được bot trong chat riêng',
          threadID,
          messageID
        );
    }
    if (!ADMINBOT.includes(senderID) && adminbot.adminOnly == true) {
      ...
      if (
        ...
        return api.sendMessage(
          '[ 𝐑𝐞𝐧𝐙𝐢𝐢 ] ➩ Admin bot mới có thể sử dụng được bot',
          threadID,
          messageID
        );
    }
    if (
      ...
      if (
        ...
        return api.sendMessage(
          '[ 𝐑𝐞𝐧𝐙𝐢𝐢 ] ➩ Admin or Người Thuê Bot mới có thể sử dụng được bot',
          threadID,
          messageID
        );
    }
    ...
    if (
      ...
      return api.sendMessage(
        '[ 𝐑𝐞𝐧𝐙𝐢𝐢 ] ➩ Qtv Box mới được sử dụng bot',
        event.threadID,
        event.messageID
      );
    if (
...
responseType: "stream"
    ...
    if (
      ...
      return api.sendMessage(
        `spam con cac=))`, threadID, messageID);
